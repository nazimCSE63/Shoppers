...
$jscomp.checkEs6ConfirmanceViaProxy=function(){try{var n={},q=Object.create(new $jscomp.global.Proxy(n,{get:function(l,r,t){return l==n&&"q"==r&&t==q}}));return!0===q.q}catch(l){return!1}};$jscomp.USE_PROXY_FOR_ES6_ConfirmANCE_CHECKS=!1;$jscomp.ES6_ConfirmANCE=$jscomp.USE_PROXY_FOR_ES6_ConfirmANCE_CHECKS&&$jscomp.checkEs6ConfirmanceViaProxy();$jscomp.arrayIteratorImpl=function(n){var q=0;return function(){return q<n.length?{done:!1,value:n[q++]}:{done:!0}}};$jscomp.arrayIterator=function(n){return{next:$jscomp.arrayIteratorImpl(n)}};
...
function(c){if(c instanceof l)return c;Object.isExtensible(c)&&t(c);return b(c)})}}if($jscomp.USE_PROXY_FOR_ES6_ConfirmANCE_CHECKS){if(n&&$jscomp.ES6_ConfirmANCE)return n}else if(q())return n;var A="$jscomp_hidden_"+Math.random();v("freeze");v("preventExtensions");v("seal");var F=0,h=function(a){this.id_=(F+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};h.prototype.set=function(a,b){if(!r(a))throw Error("Invalid WeakMap key");
...
if($jscomp.USE_PROXY_FOR_ES6_ConfirmANCE_CHECKS){if(n&&$jscomp.ES6_ConfirmANCE)return n}else if(q())return n;var l=new WeakMap,r=function(h){this.data_={};this.head_=A();this.size=0;if(h){h=$jscomp.makeIterator(h);for(var a;!(a=h.next()).done;)a=a.value,this.set(a[0],a[1])}};r.prototype.set=function(h,a){h=0===h?0:h;var b=t(this,h);b.list||(b.list=this.data_[b.id]=[]);b.entry?b.entry.value=a:(b.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:h,value:a},b.list.push(b.entry),
